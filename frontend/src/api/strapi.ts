...
export interface paths {
    "/interview-posts": {
        ...
        get: operations["get/interview-posts"];
        put?: never;
        post: operations["post/interview-posts"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/interview-posts/{id}": {
        ...
        get: operations["get/interview-posts/{id}"];
        put: operations["put/interview-posts/{id}"];
        post?: never;
        delete: operations["delete/interview-posts/{id}"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    schemas: {
        ...
        InterviewPostRequest: {
            data: {
                ...
                grade: number;
                /** @enum {string} */
                score: "early4" | "late4" | "early3" | "mid3" | "late3" | "less3";
                takeLecture: boolean;
                yearPrivacy: boolean;
                body: string;
            };
        };
        InterviewPostListResponseDataItem: {
            id?: number;
            attributes?: components["schemas"]["InterviewPost"];
        };
        InterviewPostListResponse: {
            data?: components["schemas"]["InterviewPostListResponseDataItem"][];
            meta?: {
                pagination?: {
                    page?: number;
                    pageSize?: number;
        ...
        InterviewPostResponseDataObject: {
            id?: number;
            attributes?: components["schemas"]["InterviewPost"];
        };
        InterviewPostResponse: {
            data?: components["schemas"]["InterviewPostResponseDataObject"];
...
export interface operations {
    "get/interview-posts": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["InterviewPostListResponse"];
                };
            };
    ...
    "post/interview-posts": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["InterviewPostRequest"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["InterviewPostResponse"];
                };
            };
            /** @description Bad Request */
            400: {
